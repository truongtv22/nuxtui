<template>
  <USelectMenu multiple v-model="selected" :options="data" :optionAttribute="props.title"
            :optionValue="props.value" :creatable="!status.loading" searchable :loading="status.loading" ref="categories">
            <template #label>
